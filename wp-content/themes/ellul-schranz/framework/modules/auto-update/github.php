...
if ( ! class_exists( 'Envato_Market_Github' ) ) :
	...
	class Envato_Market_Github {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'ellul-schranz' ), '1.0.0' );
		}
		...
		public function plugins_api( $api, $action, $args ) {
			if ( isset( $args->slug ) && 'ellul-schranz' === $args->slug ) {
		...
		public function notice() {
			...
			if ( 'deactivated' === $state ) {
				...
				$message = sprintf(
					esc_html__( '%sActivate the Envato Market plugin%s to get updates for your ThemeForest and CodeCanyon items.', 'ellul-schranz' ),
				...
				$message = sprintf(
					esc_html__( '%sInstall the Envato Market plugin%s to get updates for your ThemeForest and CodeCanyon items.', 'ellul-schranz' ),
