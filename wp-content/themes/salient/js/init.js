	...
	"use strict";
		...
		*/
		function clientsFadeIn() {
			...
			var $clientsOffsetPos = ($fullscreenMarkupBool == true) ? '200%' : 'bottom-in-view';
				...
				*/
				function colAndImgAnimations() {
					...
					$($fullscreenSelector + 'img.img-with-animation').each(function () {
						...
						if( $that.attr('data-animation') == 'ro-reveal-from-right' && $colAndImgOffsetPos == '88%' ||
					      $that.attr('data-animation') == 'ro-reveal-from-left' && $colAndImgOffsetPos == '88%' ) {
						...
						var waypoint = new Waypoint({
							...
							handler: function () {
								...
								if (!bypassAnimations || $('body[data-responsive="0"]').length > 0) {
									...
									else if ($that.attr('data-animation') == 'ro-reveal-from-left' || 
									$that.attr('data-animation') == 'ro-reveal-from-right' ||
								  $that.attr('data-animation') == 'ro-reveal-from-bottom' || 
								  $that.attr('data-animation') == 'ro-reveal-from-top') {
				...
				*/
				function footerRevealCalcs() {
					...
					if( $headerOuterEl.is('[data-logo-height]') && $headerOuterEl.is('[data-padding]') ) {
						var $headerNavSpace = ( headerLayoutFormat == 'left-header' && nectarDOMInfo.winW > 1000) ? 0 : parseInt($headerOuterEl.attr('data-logo-height')) + (parseInt($headerOuterEl.attr('data-padding')*2));
					} else {
						var $headerNavSpace = ( headerLayoutFormat == 'left-header' && nectarDOMInfo.winW > 1000) ? 0 : $headerOuterEl.outerHeight();
					}
					...
					if (nectarDOMInfo.winH - nectarDOMInfo.adminBarHeight - $headerNavSpace - nectarDOMInfo.footerOuterHeight - 1 - $pageHeaderBG.height() - $('.page-header-no-bg').height() > 0) {
						...
						$('body[data-footer-reveal="1"] .container-wrap').css({
							'margin-bottom': nectarDOMInfo.footerOuterHeight - 1
						});
						
						$('.container-wrap').css({
							'min-height': nectarDOMInfo.winH - nectarDOMInfo.adminBarHeight - $headerNavSpace - nectarDOMInfo.footerOuterHeight - 1 - $('.page-header-no-bg').height() - $pageHeaderBG.height() + $resizeExtra
						}); 
				...
				*/
				function footerRevealInit() {
					...
					if ($('body[data-footer-reveal="1"]').length > 0 || $('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0) {
						...
						// Don't add on mobile when using footer reveal
						if( $('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length == 0 && !$body.hasClass('mobile') ) { 
							$body.addClass('nectar-no-flex-height');
