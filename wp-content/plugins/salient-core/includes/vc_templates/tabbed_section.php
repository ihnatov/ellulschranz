...
// Vertical scrolling.
	...
	$vs_navigation_escaped = '<div class="scrolling-tab-nav"><div class="line"></div><ul class="wpb_tabs_nav ui-tabs-nav">';
	...
	$output .= '<div class="nectar-scrolling-tabs'.esc_attr($extra_class).'" data-nav-tag="'.esc_attr($vs_tab_tag).'" data-navigation-width="'.esc_attr($vs_navigation_width).'" data-color-scheme="'.esc_attr(strtolower($tab_color)).'">';
