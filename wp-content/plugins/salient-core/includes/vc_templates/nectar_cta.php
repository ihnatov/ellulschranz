...
if( $btn_style === 'material' ) {
  ...
  echo  '<span class="link_wrap" '.$style.'><a '.$target .' class="link_text'.esc_attr($link_text_classes).'" href="'.esc_url($url).'">'.wp_kses_post($link_text).'<span class="circle" '.$bg_style.'></span><span class="arrow"></span></a></span>'; 
...
// See through.
  ...
  echo  '<span class="link_wrap" '.$style_padding_markup.'><a '.$target .' class="link_text'.esc_attr($link_text_classes).'" href="'.esc_url($url).'">'.wp_kses_post($link_text).'<span class="arrow"></span></a></span>'; 
  echo '</'.esc_html($heading_tag).'></div>';
} 
// Arrow Animation.
  ...
  echo  '<span class="link_wrap" '.$style_padding_markup.'><a '.$target .' class="link_text'.esc_attr($link_text_classes).'" href="'.esc_url($url).'"><span class="text">'.wp_kses_post($link_text) .'</span>'; 
...
// All others.
  ...
  echo  '<span class="link_wrap" '.$style_padding_markup.'><a '.$target .' class="link_text'.esc_attr($link_text_classes).'" '.$border_color_attr.' href="'.esc_url($url).'">'.wp_kses_post($link_text).'</a></span>'; 
  echo '</'.esc_html($heading_tag).'></div>';
}
