	...
	<div class="awsm-table <?php echo $this->item_style($options);?>">
		<div class="awsm-table-row awsm-table-head">
			<div class="awsm-table-cell">
				<?php _e('Image','awsm-team-pro'); ?>
			</div>
			<div class="awsm-table-cell">
				<?php _e('Name','awsm-team-pro'); ?>
			</div>
			<div class="awsm-table-cell">
				<?php _e('Designation','awsm-team-pro'); ?>
			</div>
			<div class="awsm-table-cell">
				<?php _e('Short Description','awsm-team-pro'); ?>
			</div>		
			<div class="awsm-table-cell">
				<?php _e('Social Links','awsm-team-pro'); ?>
			</div>
		</div>
		<?php 
