			...
			<div class="awsm-team-customize-inner">
				<div class="awsm-team-customize-member">
					<div class="awsm-heading-group">
						<h2 class="sub-h"><?php _e('Members', 'awsm-team-pro');?></h2>
						<span><?php _e('Select members from the dropdown, drag and drop them to reorder.', 'awsm-team-pro');?></span>
					</div>
					<div class="awsm-select-members">
						...
						<select name="members" id="awsm-members">			
							<?php 
							echo '<option value="" data-img="'.$defaultimage.'">'._e('Select a member','awsm-team-pro').'</option>';
						...
						echo '<p>';
						_e('You haven’t added any team members yet. ','awsm-team-pro'); 
						echo '<a href="'.$addmember.'">'.__("Add a team member",'awsm-team-pro').'</a>';
						echo '</p>';
						endif;?>
				...
				<div class="awsm-team-customize-style">
					<div class="awsm-heading-group">
						<h2 class="sub-h"><?php echo __('Presets', 'awsm-team-pro');?></h2>
						<span><?php echo __('Choose a preset from below.', 'awsm-team-pro');?></span>
					</div>
					...
					<div class="awsm-section awsm-clearfix">
							<div class="awsm-heading-group">
								<h2 class="sub-h"><?php echo __('Style', 'awsm-team-pro');?></h2>
								<span><?php
									$url = 'http://dev.awsm.in/team/wp-demo/';
									printf( wp_kses( __( 'We have a set of predefined styles for each preset. Choose your favorite. Refer <a href="%s" target="_blank">demo</a>.','awsm-team-pro'), array(  'a' => array( 'href' => array(),'target'=>array() ) ) ), esc_url( $url ) );
									?></span>
					...
					<div class="awsm-custom-css-wrap">
						<div class="awsm-heading-group">
							<h2 class="sub-h"><?php echo __('Custom CSS', 'awsm-team-pro');?></h2>
							<span><?php echo __('Want to add your own colours and flavours? Add your custom CSS in the text box below.', 'awsm-team-pro');?></span>
						</div><!-- .awsm-heading-group -->
...
<script type="text/html" id="tmpl-awsm-member-select">
    <div class="select2-result-repository clearfix">
    	...
    	<# if ( data.disabled ) { #>
    	<span class="select2-result-repository__disabled"><?php _e('Added','awsm-team-pro');?></span>
    	<# } #>
   </div>
</script>